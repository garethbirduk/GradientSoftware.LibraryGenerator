...
dotnet script ./GradientSoftware.GithubScripts/.github/scripts/update-version.csx %GITHUB_USERNAME% GradientSoftware.LibraryGenerator %GITHUB_APIKEY% .\LibraryGenerator\LibraryGenerator.csproj %branch%
